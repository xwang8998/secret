...
accu_SMEC_GetRandom();
  ...
  //----- 打包发送 3 7-------------------
	...
	*/
	delay_nms(200);
	//i2c_single_byte_read(0xcb,00);
	//i2c_single_byte_write(unsigned char xdevaddr,unsigned char xbyte_addr,unsigned char xbyte_data);
	//i2c_single_byte_read(unsigned char xdevaddr,unsigned char RdAddr);
